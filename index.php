...
<head>
    ...
    <link rel="stylesheet" href="css/magnific-popup.css">                                     <!-- Magnific popup style -->
...
<body>
    ...
    <div class="container-fluid">
                ...
                <section class="tm-header-gallery">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 tm-pad-0">
                        <div class="tm-site-name">
                            <h1 class="text-uppercase tm-site-name-h1">Venta de Casas</h1>
                            <h2 class="tm-site-name-h2">Encuentra tu hogar ideal</h2>    
                        </div>
        ...
        <!-- Navbar adaptado para una página de venta de casas -->
<<<<<<< HEAD
...
>>>>>>> 85337c0af560825a9135af1a9189a516ff53fa82

        <div class="row tm-row-margin-b tm-content-boxes-row">
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 col-xl-4">
                <div class="tm-content-box">
                    <i class="fa fa-4x fa-home tm-content-icon"></i>
                    <h2 class="tm-content-title">Encuentra tu hogar ideal</h2>
                    <p>Explora nuestras propiedades disponibles y encuentra el lugar perfecto para ti y tu familia.</p>
                </div>
            </div>

            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 col-xl-4">
                <div class="tm-content-box">
                    <i class="fa fa-4x fa-map-marker tm-content-icon"></i>
                    <h2 class="tm-content-title">Ubicaciones privilegiadas</h2>
                    <p>Nuestras casas están ubicadas en las mejores zonas de la ciudad, cerca de todo lo que necesitas.</p>
                </div>
            </div>

            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 col-xl-4">
                <div class="tm-content-box">
                    <i class="fa fa-4x fa-money tm-content-icon"></i>
                    <h2 class="tm-content-title">Precios competitivos</h2>
                    <p>Ofrecemos precios accesibles sin comprometer la calidad de nuestras propiedades.</p>
                </div>
            </div>
        </div>
